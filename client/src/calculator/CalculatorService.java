 ...
 */
@WebServiceClient (name = "CalculatorService", targetNamespace = "http://calculator/", wsdlLocation = "http://localhost:8080/WebService_war_exploded/services/Calculator?wsdl")
public class CalculatorService
	...
	static {
		...
		try {
			url = new URL("http://localhost:8080/WebService_war_exploded/services/Calculator?wsdl");
